...
<html lang="zh-CN">
  ...
  <body>
    ...
    <div class="container">
      <form class="form-signin" role="form" action="${ctp }/user/login">
        <h2 class="form-signin-heading"><i class="glyphicon glyphicon-log-in"></i> 用户登录</h2>
        <h6 style="color: red;">${msg }</h6>
		  <div class="form-group has-success has-feedback">
			<input type="text" class="form-control" name="loginacct" placeholder="请输入登录账号" value="${TUser.loginacct }" autofocus>
